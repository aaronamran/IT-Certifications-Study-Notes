...
- 2 types of subscription boundaries > Billing boundary (determines how an Azure account is billed for using Azure, and create multiple subscriptions for different types of billing requirements) and Access control boundary (applies access-management policies at subscription level, and create separate subscriptions to reflect different organisational structures)
